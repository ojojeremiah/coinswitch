...
class ServiceProviderUtils {
  ...
  static Map<String, dynamic> findErrorDetails(
    ...
    if (statusCode == 401 || statusCode == 403) {
      if (object is List<int>) {
        ...
        error = StringUtils.fromJson(object);
      }
    }
  ...
  static T toResult<T>(List<int> bytes) {
    ...
    if (<String>[] is T) {
      return StringUtils.toJson(resultString).cast<String>() as T;
    }
    if (<bool>[] is T) {
      return StringUtils.toJson(resultString).cast<bool>() as T;
    }
    if (0 is T) {
  ...
  static T parseResponse<T>(
    ...
    try {
      ...
      if (<String, dynamic>{} is T) {
        ...
        if (object is String) {
          return StringUtils.toJson(object) as T;
        }
      }
      if (<Map<String, dynamic>>[] is T) {
        if (object is String) {
      ...
      throw RPCError(
          ...
          data: {"error": e.toString(), "excepted": "$T"},
          errorCode: 403);
    }
  }
}
